...
<table id="timetable" style="table-layout: fixed; width:80%; border-width: 1px; border-style: outset; border-collapse: collapse; border-color: gray; margin: 0 auto; ">
	...
	function makeTableRow(data, items, klass, ramadanDay) {
		...
		for (var i in items) {
			...
			if(i=='day'  || klass =='head-row')
				...
				cell.innerHTML = 'Ramadan ' + ramadanDay +' 1439'
