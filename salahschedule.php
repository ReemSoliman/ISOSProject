...
<head>
	...
	<title>ISOS- Salat Schedule</title>
	...
	<meta name="viewport" content="width=device-width, initial-scale=0.5">
		...
		.timetable {width: 60%; border-width: 1px; border-style: outset; border-collapse: collapse; border-color: gray; margin: 0 auto;}
		.timetable td {border-width: 1px; border-spacing: 1px; padding: 0.1em; border-style: inset; border-color: #CCCCCC;}
...
<h2 class="pageTitle" style="margin-left:0.5em;">Salat Schedule</h2>

<div style="width:100%;"  >
<div >
 <p class="smaller">Salat (Prayer) Timetable in Portland, OR local time using Islamic Society of North America Method.</p>
</div>
<div style="width:100%;">
...
<table id="timetable" style="width: 60%; border-width: 1px; border-style: outset; border-collapse: collapse; border-color: gray; margin: 0 auto;">
	<tbody></tbody>
</table>
</div>
